...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiosignal-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14401&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiosignal-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiosignal` can be installed with:

```
conda install aiosignal
```

It is possible to list all of the versions of `aiosignal` available on your platform with:
